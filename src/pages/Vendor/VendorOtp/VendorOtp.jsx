...
const VendorOtp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/vendor/login"); // Replace with the actual route you want to navigate to
    } catch (error) {
      setLoading(false);
...
<p className="mb-5 text-center">Verify email using the otp sent to your  email</p>
                  <input
                    type="password"
