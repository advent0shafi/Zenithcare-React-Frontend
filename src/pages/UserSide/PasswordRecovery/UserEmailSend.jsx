        ...
        <div class=" md:w-1/2 h-full md:p-12 p-2 bg-white-500 ">
          <div class="bg-grey-lighter min-h-screen flex flex-col ">
            <div class="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
              {verify ? (
                <div class="px-6 py-8 rounded shadow-[0_3px_10px_rgb(0,0,0,0.2)] text-black w-full">
                  <div className=" pl-28">
                    <img className="w-[80px] pl-1" src={image} alt="" />
                  </div>
                  <form>
                    <h1 class="mb-8 text-xl text-center">Forget Password</h1>
                ...
                <form>
                  <h1 class="mb-8 text-xl text-center">OTP</h1>
