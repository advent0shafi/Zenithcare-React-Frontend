     ...
     {  toggle ? <div
        ...
        >
          <button className="flex items-center p-2 text-gray-500 bg-white rounded-full shadow text-md">
            ...
            >
              <path
                d="M1376 672L928 1120 480 672l-112 112 448 448-448 448 112 112 448-448 448 448 112-112-448-448 448-448z"
                fill="#000000"
              />
            </svg>
          </button>
        ...
        <div className="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
          <div className="relative flex items-center justify-end w-full p-1 space-x-4">
            ...
            {/* <div className="flex items-center md:hidde" >
        ...
        <div
        className={
          toggle ? "absolute z-10 p-4 mt-16 bg-[#1F2937] w-full px-8 md:hidden" : "hidden"
        }
      >
        <ul>
          <li className="p-4 hover:bg-gray-100">Home</li>
          <li className="p-4 hover:bg-gray-100">UserList</li>
